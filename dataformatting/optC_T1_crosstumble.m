...
ColourQuiver_SB( RawData.X, RawData.Y, RawData.U( :, :, CrankAngleNo_plot, CycleNo_plot ), RawData.V( :, :, CrankAngleNo_plot, CycleNo_plot ), figureprop );
% title('Before Masking')

IntakeValve_Mask.TP_CA280.Point1 = [ 13.02, 2.62 ]; % Tumble_CR11_T2_C33_DVA, -280 CAD aTDCf
IntakeValve_Mask.TP_CA280.Point2 = [ 23.54, -5.02 ]; % Tumble_CR11_T2_C33_DVA, -280 CAD aTDCf
...
ColourQuiver_SB( RawData.X, RawData.Y, IntakeValve_MaskedData.U( :, :, CrankAngleNo_plot, CycleNo_plot ), IntakeValve_MaskedData.V( :, :, CrankAngleNo_plot, CycleNo_plot ), figureprop );
...
% [ InterpolatedData, MaskedData, PODData ] = PIVDataFormatting_nomask( RawData.X, RawData.Y, RawData.U, RawData.V, RawData.CrankAngle );
...
[ ~, CheckData.CrankAngleNo_Using ] = ismember( CheckData.CrankAngle, RawData.CrankAngle );
...
quiver( RawData.X,RawData.Y, RawData.U(:,:, CheckData.CrankAngleNo_Using,CheckData.CycleNo),RawData.V(:,:, CheckData.CrankAngleNo_Using,CheckData.CycleNo),'b' )
...
quiver( RawData.X,RawData.Y, RawData.U(:,:, CheckData.CrankAngleNo_Using,CheckData.CycleNo),RawData.V(:,:, CheckData.CrankAngleNo_Using,CheckData.CycleNo),'r' )
