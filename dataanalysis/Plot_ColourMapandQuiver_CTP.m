function [ hf1, ha1, hc1 ] = Plot_ColourMapandQuiver_CTP( Figure_No, Data_x, Data_y, Data_u, Data_v, Data_mag,...
...
x_pcolor = Data_x - 2*xPcolorShift;
y_pcolor = Data_y - 2*yPcolorShift;
